...
int main(int argc, char const *argv[])
{
    ...
    glm::mat4 model = glm::translate(glm::mat4(1.0f), glm::vec3(200, 200.0f, 0));
    
    glm::mat4 mvp = projection * view * model; // Ok to do on CPU since for now camera is not moving (i.e. multiplication is done only once)

    // You need to run the binary from lesson directory '019-mvp-matrices' for these relative paths to work
